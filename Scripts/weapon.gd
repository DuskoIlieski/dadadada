...
func fire():
	...
	if $AssaultRifleWest/AnimationPlayer != null:
		$AssaultRifleWest/AnimationPlayer.stop(true)
		$AssaultRifleWest/AnimationPlayer.play("shoot")
...
func reload():
	...
	can_shoot = false
	if $AssaultRifleWest/AnimationPlayer != null:
		$AssaultRifleWest/AnimationPlayer.play("reload")
